extends Node3D
@onready var background_viewport_container = $base_camera/background_viewport_container/background_viewport
@onready var forground_viewport_container = $base_camera/forground_viewport_container/forground_viewport
...
func resize():
	background_viewport_container.size = DisplayServer.window_get_size()
	forground_viewport_container.size = DisplayServer.window_get_size()
